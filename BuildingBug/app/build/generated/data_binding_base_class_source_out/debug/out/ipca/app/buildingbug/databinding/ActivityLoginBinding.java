...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView backgroundImageView, @NonNull Button loginButton,
      @NonNull EditText passwordEditText, @NonNull TextView signUpTextView,
      @NonNull EditText usernameEditText, @NonNull TextView welcomeTextView) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, backgroundImageView, loginButton,
          passwordEditText, signUpTextView, usernameEditText, welcomeTextView);
    }
